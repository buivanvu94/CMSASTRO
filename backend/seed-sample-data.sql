-- ============================================
-- SEED SAMPLE DATA
-- Tạo dữ liệu mẫu cho Categories, Posts và Products
-- ============================================
...
-- ============================================
-- 2. POSTS (8 items)
-- Lưu ý: Cần có user với id=1 trong bảng users trước khi chạy
-- Nếu chưa có, chạy lệnh sau trước:
-- INSERT INTO users (username, email, password, role, status) VALUES ('admin', 'admin@example.com', '$2b$10$hash', 'admin', 'active');
-- ============================================
